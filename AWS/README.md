...
### Client-Server Model
A client can be a web browser or an application that a customer interacts to make requests to computer servers(Think as an analogy of a customer at a barista ordering a coffee). One such type of virtual server is Amazon Elastic Compute Cloud(EC2).
### Cloud Computing
